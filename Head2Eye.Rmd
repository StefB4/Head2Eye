...
for area in ["Westbrueck","MountainRoad","CountryRoad","Autobahn"]:
    ...
    for segment in reference_input_files[area]["path_segments_resampled"]:
        ...
        reference_paths[area][segment].drop(columns=["TimeStamp","path_segment_label","rebased_timestamp","rebased_timestamp_rounded"],inplace=True)
